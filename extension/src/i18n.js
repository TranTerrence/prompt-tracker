...
const CoachI18n = (() => {
  const MESSAGES = {
    fr: {
      ...
      // Popup 1.0.3 : Insérer dans l'onglet de chat actif, Copier sinon.
      libraryInsert: "Insérer",
      libraryCopy: "Copier",
      ...
      // vide, raccourci clavier, ou bouton de la pastille. Il n'envoie jamais.
      pickerTitle: "Bibliothèque de prompts",
      pickerSearch: "Rechercher un prompt…",
      pickerHint: "↑↓ choisir · Entrée insérer · Maj+Entrée copier · Échap fermer",
      pickerClose: "Fermer",
      pickerGroupStarred: "Favoris",
      pickerGroupRecent: "Récents",
      pickerGroupOfficial: "Du programme",
      pickerGroupPeer: "De ta promotion",
      pickerCopy: "Copier",
      pickerInsert: "Insérer",
      pickerManage: "Gérer dans la bibliothèque",
      pickerNotReady: "La bibliothèque n'est pas encore chargée. Réessaie dans un instant.",
      pickerEmpty: "Aucun prompt publié pour le moment.",
      pickerNoMatch: "Aucun prompt ne correspond.",
      pickerCopied: "Copié. Colle-le dans la zone de message.",
      pickerCopiedFallback: "Impossible d'insérer ici : le prompt a été copié. Colle-le dans la zone de message.",
      badgePrompts: "📚 Prompts",
      badgePromptsTitle: (chord) => `Ouvrir la bibliothèque de prompts (${chord}, ou tape // dans un message vide)`,
      ...
      // Vue construite : le prompt se fabrique sous les yeux, un bloc par
      // réponse. « Modifier » expose le texte brut, exactement celui qui part.
      modalPreviewOriginal: "Ta demande",
      modalPreviewEmpty: "Tes réponses viendront s'ajouter ici, sous ta demande.",
      modalPreviewEdit: "modifier le texte",
      modalPreviewEditTitle: "Éditer le texte exact qui sera envoyé",
      modalPreviewDone: "revenir à la vue construite",
      modalPreviewAdded: (label) => `Ajouté au prompt : ${label}`,
      modalScoreProgress: (before, after) => `Score initial ${before}, score actuel ${after}`,
    ...
    en: {
      ...
      pickerSearch: "Search a prompt…",
      pickerHint: "↑↓ choose · Enter insert · Shift+Enter copy · Esc close",
      pickerClose: "Close",
      pickerGroupStarred: "Starred",
      pickerGroupRecent: "Recent",
      pickerGroupOfficial: "From the programme",
      pickerGroupPeer: "From your cohort",
      pickerCopy: "Copy",
      pickerInsert: "Insert",
      pickerManage: "Manage in the Library",
      pickerNotReady: "The library is not loaded yet. Try again in a moment.",
      pickerEmpty: "No prompts published yet.",
      pickerNoMatch: "No prompt matches.",
      pickerCopied: "Copied. Paste it into the message box.",
      pickerCopiedFallback: "Couldn't insert here, so the prompt was copied. Paste it into the message box.",
      badgePrompts: "📚 Prompts",
      badgePromptsTitle: (chord) => `Open the Prompt Library (${chord}, or type // in an empty message)`,
      ...
      modalPreviewOriginal: "Your request",
      modalPreviewEmpty: "Your answers will appear here, below your request.",
      modalPreviewEdit: "edit the text",
      modalPreviewEditTitle: "Edit the exact text that will be sent",
      modalPreviewDone: "back to the built view",
      modalPreviewAdded: (label) => `Added to the prompt: ${label}`,
      modalScoreProgress: (before, after) => `Initial score ${before}, current score ${after}`,
