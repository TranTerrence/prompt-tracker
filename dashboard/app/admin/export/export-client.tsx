...
const HEADERS = [
  ...
  "rounds",
  "answers_count",
  // Mesures post-réponse. ⚠️ Ce tableau est POSITIONNEL : toute colonne
  // ajoutée ici doit l'être au même rang dans le tableau de ligne plus bas,
  // sinon le CSV se décale silencieusement au lieu de lever une erreur.
  "prompt_chars",
  "model",
  ...
  "read_ms",
  "response_outcome",
  // Contenu soumis à consentement, gardé en fin de ligne.
  "conv_key",
  "text",
  "dialogue",
];
